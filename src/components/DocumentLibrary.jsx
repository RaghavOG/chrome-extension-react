...
const documents = [
  {
    ...
    file: "CHO 22AI011-Optimization Techniques updated.pdf",
  },
  {
    name: "Database Management Systems",
    file: "CHO 22CS007-Database Management Systems.pdf",
  },
  {
    name: "Applied Probability and Random Processes",
    file: "CHO-22As019-Applied Probability and Random Processes.pdf",
  },
  {
    name: "Supervised & Unsupervised Learning",
    file: "CHO_22AI010(Supervised  Unsupervised Learning)_CSE(AI).pdf",
  },
  {
    name: "Object Oriented Programming using Java",
    file: "CHO_22CS010(Object Oriented Programming using Java)_CSE(AI).pdf",
  },
];

export default function DocumentLibrary() {
  const handleOpen = (file) => {
    window.open(`/` + encodeURIComponent(file), '_blank');
  };
